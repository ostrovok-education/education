...
const DEFAULT_FORM_STATUS_TEXT =
  'Рады видеть вас в образовательном центре «Островок»! После нажатия откроется Telegram с готовым текстом заявки.';
...
if (trialForm && formStatus) {
  ...
  trialForm.addEventListener('submit', (event) => {
    ...
    formStatus.textContent = DEFAULT_FORM_STATUS_TEXT;
